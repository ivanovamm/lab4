...
public class Main {
    public static void main(String[] args) {
        ...
        Food eskalop = new Food("эскалопы", 10);
        ...
        System.out.println(Karlson.getName() + Karlson.showMood() + Karlson.purpose("после ночных приключений с", Karlson) + Fille.getName() + " и " + Rulle.getName());
        ...
        System.out.println(Karlson.like() + " " + pudding.flavour + pudding.name);
